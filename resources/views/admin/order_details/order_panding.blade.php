                  ...
                  <div class="card card-warning">
                    <div class="card-header ">
                      ...
                      <div class="card-tools">
                          ...
                          <div class="btn btn-primary float-right" style="margin-left:20px; margin-right:20px;"><a href="{{ url('admin/order/panding') }}" style="color:White;">Refresh</a></div>                  
                      </div>
